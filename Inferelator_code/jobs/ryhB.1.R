...
PARS$priors.file <- 'ryhB.copra.pval.csv'
PARS$gold.standard.file <- 'ryhB.copra.pval.csv'
...
PARS$save.to.dir <- paste('output/ryhB_silico_1', PARS$method, PARS$prior.weight, PARS$perc.tp, PARS$perc.fp, sep='_')
