...
PARS$priors.file <- 'ryhB.copra.top100.csv'
PARS$gold.standard.file <- 'ryhB.copra.top100.csv'
...
PARS$save.to.dir <- paste('output/ryhB_silico_0', PARS$method, PARS$prior.weight, PARS$perc.tp, PARS$perc.fp, sep='_')