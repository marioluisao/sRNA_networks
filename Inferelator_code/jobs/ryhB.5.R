...
PARS$priors.file <- 'ryhB.copra.enriched.or.pval.csv'
PARS$gold.standard.file <- 'ryhB.copra.enriched.or.pval.csv'
...
PARS$save.to.dir <- paste('output/ryhB_silico_5', PARS$method, PARS$prior.weight, PARS$perc.tp, PARS$perc.fp, sep='_')
