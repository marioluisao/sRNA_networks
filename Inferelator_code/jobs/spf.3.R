...
PARS$priors.file <- 'spf.copra.enriched.and.pval.csv'
PARS$gold.standard.file <- 'spf.copra.enriched.and.pval.csv'
...
PARS$save.to.dir <- paste('output/spf_silico_3', PARS$method, PARS$prior.weight, PARS$perc.tp, PARS$perc.fp, sep='_')
