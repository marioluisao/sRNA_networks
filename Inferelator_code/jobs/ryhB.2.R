...
PARS$priors.file <- 'ryhB.copra.enriched.csv'
PARS$gold.standard.file <- 'ryhB.copra.enriched.csv'
...
PARS$save.to.dir <- paste('output/ryhB_silico_2', PARS$method, PARS$prior.weight, PARS$perc.tp, PARS$perc.fp, sep='_')
