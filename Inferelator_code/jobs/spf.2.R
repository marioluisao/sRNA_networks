...
PARS$priors.file <- 'spf.copra.enriched.csv'
PARS$gold.standard.file <- 'spf.copra.enriched.csv'
...
PARS$save.to.dir <- paste('output/spf_silico_2', PARS$method, PARS$prior.weight, PARS$perc.tp, PARS$perc.fp, sep='_')
