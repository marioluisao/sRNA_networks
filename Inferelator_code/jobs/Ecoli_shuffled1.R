...
PARS$priors.file <- 'trn_shuffled_sRNA_priors_1.csv'
PARS$gold.standard.file <- 'trn_shuffled_sRNA_priors_1.csv'
...
PARS$save.to.dir <- 'output/Ecoli_shuffled_sRNA_priors1'
