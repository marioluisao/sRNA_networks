...
PARS$priors.file <- 'spf.copra.top100.csv'
PARS$gold.standard.file <- 'spf.copra.top100.csv'
...
PARS$save.to.dir <- paste('output/spf_silico_0', PARS$method, PARS$prior.weight, PARS$perc.tp, PARS$perc.fp, sep='_')
