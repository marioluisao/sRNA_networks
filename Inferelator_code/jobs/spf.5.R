...
PARS$priors.file <- 'spf.copra.top15plus.csv'
PARS$gold.standard.file <- 'spf.copra.top15plus.csv'
...
PARS$save.to.dir <- paste('output/spf_silico_5', PARS$method, PARS$prior.weight, PARS$perc.tp, PARS$perc.fp, sep='_')
