...
PARS$priors.file <- 'inf_noisy_sRNA_priors_1_n1_r7.csv'
PARS$gold.standard.file <- 'inf_noisy_sRNA_priors_1_n1_r7.csv'
...
PARS$save.to.dir <- 'output/eco_sRNA_strong_m3F_unaveraged_noisyPriors_n1_r7'
