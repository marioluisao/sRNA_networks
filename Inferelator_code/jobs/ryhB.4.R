...
PARS$priors.file <- 'ryhB.copra.enriched.and.pval.csv'
PARS$gold.standard.file <- 'ryhB.copra.enriched.and.pval.csv'
...
PARS$save.to.dir <- paste('output/ryhB_silico_4', PARS$method, PARS$prior.weight, PARS$perc.tp, PARS$perc.fp, sep='_')
